...
def test_migration_0002_on_fresh_db(tmp_path):
    ...
    try:
        ...
        assert applied == ["0001_baseline_implied_schema", "0002_auth_sessions",
                           ...
                           "0005_company_role_mapping", "0006_saved_jobs_tracker", "0007_role_view_events", "0008_job_link_reports", "0009_copilot_config", "0010_copilot_onboarding", "0011_mentor_keys", "0012_tutor_memory", "0013_tutor_conversations", "0014_conversation_live_meta"]
...
def test_migration_0002_backs_out_on_failure(tmp_path):
    ...
    try:
        ...
        assert database.run_migrations() == ["0001_baseline_implied_schema",
                                             ...
                                             "0004_esco_import", "0005_company_role_mapping",
                                             "0006_saved_jobs_tracker",
                                             "0007_role_view_events", "0008_job_link_reports", "0009_copilot_config", "0010_copilot_onboarding", "0011_mentor_keys", "0012_tutor_memory", "0013_tutor_conversations", "0014_conversation_live_meta"]
    finally:
        database.set_db_for_test()
        conn.close()
